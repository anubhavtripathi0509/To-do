...
function Header() {
    ...
    useEffect(() => {
        // This is a placeholder. Replace this with actual logic to check login status
        const checkLoginStatus = () => {
            // Example logic; replace with real authentication check
            const loggedIn = localStorage.getItem('isLoggedIn') === 'true'; // Example check
    ...
    const handleLogout = () => {
        ...
        localStorage.removeItem('isLoggedIn'); // Example logout logic
        setIsLoggedIn(false);
            ...
            <div className="relative mx-auto flex max-w-screen-lg flex-col py-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <nav aria-label="Header Navigation" className="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
                    <ul className="flex flex-col gap-y-4 sm:flex-row sm:gap-x-8">
                        <li><a className="text-gray-600 hover:text-blue-600" href="/pricing">Pricing</a></li>
